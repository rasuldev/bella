            ...
            <div class="cont_block clear">
                ...
                <aside>
                    <form action="">
                        ...
                        <p><input type="text" placeholder="Номер телефона..." required/><i class="ico_tel2"></i></p>
                        <p><textarea placeholder="Ваше сообщение..." required></textarea><i class="ico_plane"></i></p>
                        <div>
