...
?>
    ...
    <div class="inner_page clear">
        <div class="path">
            <a href="">главная</a> <a href="">категория</a> • <a href="">кухонная</a> • <a href="" class="active">кофейная
                посуда</a>
        </div>
        <div class="cont_block clear">
                ...
                <form id="f_feedback_FID1" name="f_feedback_FID1" action="" method="post" enctype="multipart/form-data">
                    ...
                    <? $APPLICATION->IncludeComponent(
                        ...
                        Array(
                            ...
                            "PROPERTY_FIELDS_REQUIRED" => array("PHONE", "FIO", "EMAIL", "PASSWORD", "FEEDBACK_TEXT"),
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <p class="soc">
                            <a href=""><i class="ico_fb"></i></a> <a href=""><i class="ico_vk"></i></a> <a href=""><i
                                    class="ico_ok"></i></a>
                        </p>
                    </li>
                </ul>
