...
?>
<div class="bx-authform form_block">
            ...
            <form method="post" action="<?= $arResult["AUTH_URL"] ?>" name="bform">
                ...
                <div class="bx-authform-formgroup-container">
                    <div class="bx-authform-label-container">
                        <spanclass="bx-authform-starrequired">*</span><?= GetMessage("AUTH_CONFIRM") ?></div>
                    <div class="bx-authform-input-container">
                        <? if ($arResult["SECURE_AUTH"]): ?>
                ...
                <div class="bx-authform-formgroup-container">
                    <div class="bx-authform-label-container"><? if ($arResult["EMAIL_REQUIRED"]): ?><span
                            class="bx-authform-starrequired">*</span><? endif ?><?= GetMessage("AUTH_EMAIL") ?></div>
                    <div class="bx-authform-input-container">
                        <p>
                ...
                <div class="bx-authform-link-container">
                    <a id="auth" href="javascript:void(0)" rel="nofollow"><b><?= GetMessage("AUTH_AUTH") ?></b></a>
                </div>
