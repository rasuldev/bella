...
<div id="<? echo $arItemIDs['ID']; ?>">
    ...
    ?>
        ...
        <span id="<? echo $arItemIDs['NOT_AVAILABLE_MESS']; ?>" class="bx_notavailable"
              style="display: <? echo(!$canBuy ? '' : 'none'); ?>;"><? echo $notAvailableMessage; ?>
        </span>
        <?
        ...
        <p class="dop_cat">
            <span>Категория:</span> <a
                href="<?= 'http://' . $_SERVER["SERVER_NAME"] . '/catalog/' . $arResult["SECTION"]["CODE"] . '/' ?>"><?= $arResult["SECTION"]["NAME"] ?></a>
        </p>
        ...
        <div id="tab_oplat">
            ...
            <div>
                ...
                <p>Стоимость доставки в пределах МКАД и до 20 км за МКАД составляет 400 рублей. В пределы МКАД также
                    ...
                    Доставка осуществляется на следующий день после покупки. Оформляется только на товар, имеющийся в
                    наличии на складах Компании и при условии поступления заказа до 16:00 текущего дня. Время доставки с
                    9:00 до 15:00 либо с 15:00 до 21:00.
                    ...
                    Внимание!!!<br/>
                    Если Вам не привезли заказанную в интернет магазине технику в срок в соответствии с указанной датой
                    при создании заказа , то повторная доставка будет для Вас бесплатной*
                </p>

                <p>Оплата производится: наличными при получении, перечеслением на карту Сбербанка, оплата выставленного
                    счета.. </p>
            </div>
