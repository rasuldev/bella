...
if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)
	die();
?>
<div class="bx-auth-reg form_block">
...
<?
		...
		default:
			...
			<?
				if($FIELD == "LOGIN")
				{?>
					<input size="30" class="login_field_param" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" />
				<?}
				else
				{
					if($FIELD == "EMAIL")
					{?>
					<input size="30" class="email_field_param" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" />
