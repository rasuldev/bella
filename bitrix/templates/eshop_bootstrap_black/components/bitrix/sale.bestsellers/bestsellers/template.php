			...
			<li><aside class="prod">
				<figure>
					...
					<?if($arItem['PREVIEW_PICTURE']['SRC'] != "") {?>
						<a class="img_prod" href="<?=$arItem['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>"><img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt="<? echo $imgTitle; ?>"/></a>
					<?} else {?>
						<a class="img_prod" href="<?=$arItem['DETAIL_PAGE_URL']?>" title="<?=$productTitle?>"><img src="\bitrix\templates\eshop_bootstrap_black\components\bitrix\sale.bestsellers\bestsellers\images\no_photo.png" alt="<? echo $imgTitle; ?>" style="display: inline-block"></a>
					<?}?>
					<p class="hover_prod">
