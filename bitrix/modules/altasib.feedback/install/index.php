...
Class altasib_feedback extends CModule
{
	...
	function InstallFiles()
	{
		...
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/altasib.feedback/install/fancybox2",$_SERVER["DOCUMENT_ROOT"]."/bitrix/js/altasib.feedback/fancybox2",true,true);
		CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/altasib.feedback/install/jquery.form",$_SERVER["DOCUMENT_ROOT"]."/bitrix/js/altasib.feedback/jquery.form",true,true);
